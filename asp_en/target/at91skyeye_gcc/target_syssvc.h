 ...
 * 
 *  @(#) $Id: target_syssvc.h 2036 2011-03-03 15:11:14Z ertl-honda $
 */

/*
 *  the chip dependent part of system service (for AT91SKYEYE)
 *
 ...
 *  serial port number
 */
#define TNUM_PORT        1        /* the number of supported serial port */
